...
public class LTI13OIDCProtocolMapper extends AbstractOIDCProtocolMapper
    ...
    private JsonNode get(String url, Map<String, String> headers, Map<String, String> parameters) {
        try {
            ...
            throw new RemoteClaimException("Error building URL", url, e);
    ...
    private JsonNode request(String method, String url, Map<String, String> headers, Map<String, String> formParameters) {
        ...
        try {
             ...
             */
            throw new RemoteClaimException("Error when accessing remote claim", url, e);
        ...
        if (response.getStatus() != 200) {
            response.close();
            throw new RemoteClaimException("Wrong status received for remote claim - Expected: 200, Received: " + response.getStatus(), url);
        }
        ...
        try {
            ...
            throw new RemoteClaimException("Error when parsing response for remote claim", url, e);
        } finally {
            response.close();
        }
    }
    ...
    private String getClientToken(ProtocolMapperModel mappingModel) {
        ...
        if (!jsonNode.has("access_token")) {
            throw new RemoteClaimException("Access token not found", baseUrl);
        }
